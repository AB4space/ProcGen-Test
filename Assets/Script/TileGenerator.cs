...
public class TileGenerator : EditorWindow
{
    ...
    void GenerateGrid()
    {
        ...
        GameObject parent = new GameObject("Cube_Green_Grid");
    ...
    void CreateTile(Vector3 pos, Vector2Int id, Transform parent)
    {
        ...
        newTile.GetComponent<Cube_Green>().GridCoordinates = id;
    }
}
